...
<div>
    ...
    <main class="bg-purple1 h-[92%] flex flex-col justify-center items-center">
        <h2 class="text-[30px] text-center mb-3 text-purple5 font-bold">Wydatki</h2>
            ...
            <div class="bg-purple1 flex flex-col justify-between w-[96%] min-h-[97%] mx-[2%] mt-[1%] rounded-[30px] overflow-x-auto">
                ...
                <table class="table-auto w-full h-[5%] text-center">
                    <tr class="bg-purple4 h-[55px] w-full ">
                        ...
                        <td class="min-w-[100px] table-item-th">Kategoria</td>
                        <td class="min-w-[80px] table-item-th">Cena</td>
                        <td class="min-w-[220px] table-item-th">link</td>
                        <td class="min-w-[110px] table-item-th">data</td>
                    ...
                    @foreach($expenses as $expense)
                        <tr class="bg-purple3 h-auto border-b-4 border-purple2">
                            <td class="table-item-td">{{$expense->id}}</td>
                            <td class="table-item-td">{{$expense->category}}</td>
                            <td class="table-item-td">{{$expense->price}}</td>
                            <td class="table-item-td">{{$expense->link}}</td>
                            <td class="table-item-td">{{$expense->date}}</td>
                            <td class="table-item-td">{{$expense->comment}}</td>
